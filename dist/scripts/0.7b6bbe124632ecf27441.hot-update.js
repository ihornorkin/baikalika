		...
		var smooth = function smooth() {
			if (elements.navigation_teaser) {
				(0, _jquery2.default)(elements.navigation_teaser).on("click", "a", function (event) {
					var src = (0, _jquery2.default)(".teaser-iframe").attr('src');
					(0, _jquery2.default)(".teaser-iframe").attr('src', src + '#page=3');
					// $(".teaser-iframe").src($(".teaser-iframe").src() + '#page=3');
				});
			} else {
...
//# sourceMappingURL=0.7b6bbe124632ecf27441.hot-update.js.map