		...
		var smooth = function smooth() {
			if (elements.navigation_teaser) {
				(0, _jquery2.default)(elements.navigation_teaser).on("click", "a", function (event) {
					(0, _jquery2.default)(".teaser-iframe").attr('src', 'Baikalika-teaser-RU.pdf#page=3');
					(0, _jquery2.default)(".teaser-iframe").contentWindow.location.reload(true);
					console.log((0, _jquery2.default)(".teaser-iframe").contentWindow, (0, _jquery2.default)(".teaser-iframe"));
				});
			} else {
...
//# sourceMappingURL=0.3e5143ad7a7cba1214be.hot-update.js.map