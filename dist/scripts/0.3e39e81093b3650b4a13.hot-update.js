		...
		var smooth = function smooth() {
			if (elements.navigation_teaser) {
				(0, _jquery2.default)(elements.navigation_teaser).on("click", "a", function (event) {
					...
					(0, _jquery2.default)(".teaser-iframe").document.context.location.reload;
					console.log((0, _jquery2.default)(".teaser-iframe document").context.location.reload);
...
//# sourceMappingURL=0.3e39e81093b3650b4a13.hot-update.js.map