	...
	var mainModule = function () {
	  ...
	  */
		...
		var smooth = function smooth() {
			elements.navigations && (0, _jquery2.default)(elements.navigations).on("click", "a", function (event) {
			...
			elements.navigation_teaser && (0, _jquery2.default)(elements.navigation_teaser).on("click", "a", function (event) {
				(0, _jquery2.default)(".teaser-iframe").animate({ scrollTop: 1400 }, 500);
				// event.preventDefault();
...
//# sourceMappingURL=0.b9de17f5cadca57a3265.hot-update.js.map