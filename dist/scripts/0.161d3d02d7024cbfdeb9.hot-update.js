	...
	var mainModule = function () {
	  ...
	  */
		...
		var timer = function timer() {
			...
			/* Set current date */
			var pastDate = new Date(2017, 8, 30, 0, 0, 0, 0);
			...
			(0, _jquery2.default)('.flip-clock-label').each(function (i) {
		...
		var parallax = function parallax() {
			(0, _jquery2.default)(window).on('load scroll', function () {
				...
				var speed = 0.28;
				(0, _jquery2.default)(elements.video).css('transform', 'translateY(' + -(scrolled * speed) + 'px)');
			});
		};
...
//# sourceMappingURL=0.161d3d02d7024cbfdeb9.hot-update.js.map