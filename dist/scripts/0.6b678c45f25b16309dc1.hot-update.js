...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mainModule = function () {
		...
		var cacheDOM = function cacheDOM() {
			...
			self.timer_ch = (0, _jquery2.default)('#timer_ch');
			...
			self.team_container = (0, _jquery2.default)('.team-container');
			/* self.elementName = $(); */
			return self;
		};
	  ...
	  */
		...
		var timer_ch = function timer_ch() {
			...
			var words = ['天', 'Часы', 'Минуты', 'Секунды'];
			(0, _jquery2.default)('#timer_ch .flip-clock-label').each(function (i) {
				(0, _jquery2.default)(this).text(words[i]);
			});
		};
		...
		var smooth = function smooth() {
			if (elements.navigation_teaser) {
				(0, _jquery2.default)(elements.navigation_teaser).on("click", "a", function (event) {
					...
					(0, _jquery2.default)('.teaser-block').animate({ scrollTop: top }, 400);
				});
			} else {
		...
		var team_container = function team_container() {
			(0, _jquery2.default)('.team__description').mCustomScrollbar();
		};
...
//# sourceMappingURL=0.6b678c45f25b16309dc1.hot-update.js.map