		...
		var smooth = function smooth() {
			if (elements.navigation_teaser) {
				(0, _jquery2.default)(elements.navigation_teaser).on("click", "a", function (event) {
					// $(".teaser-iframe").prop('src', 'Baikalika-teaser-RU.pdf#page=3');
					//
	
					if ((0, _jquery2.default)('.teaser-iframe').length) {
						(0, _jquery2.default)('.teaser-iframe').remove();
					}
	
					var page = 3;
					(0, _jquery2.default)('<iframe class="teaser-iframe" src="Baikalika-teaser-RU.pdf#page=3">').appendTo('.teaser-block');
...
//# sourceMappingURL=0.e82b0724c9b8f6b32a09.hot-update.js.map