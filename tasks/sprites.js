...
const spritesDirPath = 'app/images/sprites';
const imgPath = '../images/sprites/';
const tmplName = 'scss_retina.template.handlebars';
const tmplPath = '../node_modules/spritesmith-scss-retina-template';
...
gulp.task('sprites', () => {
	...
	const imgStream = spriteData.img.pipe(gulp.dest('app/images/sprites'));
